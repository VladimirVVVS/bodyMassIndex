...
Чтобы дробное превратить в целое, можете использовать приведение типов:
 (int) index, где index имеет дробный тип. Пример для самопроверки:
  для роста 1.87 метра и веса 98 кг он будет 28.
...
Индекс массы тела вычисляется так: BMI = m/h*h, где: BMI - индекс массы тела m - масса тела (кг) h - рост (м).
Пример: Ваш рост составляет 165 см, а вес - 53 кг. BMI = 53 / 1,65*1,65 = 53 / 2,72 = 19,49.
